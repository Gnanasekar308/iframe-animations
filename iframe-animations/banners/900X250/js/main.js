...
function startad() {
    ...
    setTimeout(function () {
        document.getElementById('text4').style.transition='all 0.3s';
        document.getElementById('text4').style.transform='translatex(305px)';
        document.getElementById('text4').style.opacity = 1;
        document.getElementById('text5').style.transition='all 0.3s';
        document.getElementById('text5').style.transform='scale(1)';
        document.getElementById('text5').style.opacity = 1;
    },6000)
    setTimeout(function () {
        document.getElementById('num3').style.transition='all 0.3s';
        document.getElementById('num3').style.transform='translateX(347px)';
        document.getElementById('num3').style.opacity=1;
        document.getElementById('num4').style.transition='all 0.3s';
        document.getElementById('num4').style.transform='scale(1)';
        document.getElementById('num4').style.opacity=1;
    },6000)
    setTimeout(function () {
        document.getElementById('img7').style.transition='all 0.1s';
        document.getElementById('img7').style.transform='translateY(77px)';
        document.getElementById('img8').style.transition='all 0.1s';
        document.getElementById('img8').style.transform='translateY(78px)';
       
    },6300)
    setTimeout(function () {
        document.getElementById('btn2').style.transform='scale(1)';
        document.getElementById('btn2').style.transition="all 0.1s";
        document.getElementById('text6').style.opacity=1;
         document.getElementById('text6').style.transform='translateY(-64px)';
         document.getElementById('text6').style.transition='all 0.2s';
